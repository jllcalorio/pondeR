...
changes, testing statistical associations, and visualization.
...
- [`run_single_assoc()`](https://jllcalorio.github.io/pondeR/reference/run_single_assoc.md)
...
- [`run_lefse()`](https://jllcalorio.github.io/pondeR/reference/run_lefse.md)
...
- [`plot_oddsratio()`](https://jllcalorio.github.io/pondeR/reference/plot_oddsratio.md)
  : Plot Odds Ratios
...
“Functions to assess/validate questionnaires using subject-matter expert
(SME) ratings.”

- [`run_contentvalidity()`](https://jllcalorio.github.io/pondeR/reference/run_contentvalidity.md)
  : Run Comprehensive Item-Level and Scale-Level Content Validity
  Analysis
- [`run_contentvaliditycvr()`](https://jllcalorio.github.io/pondeR/reference/run_contentvaliditycvr.md)
...
- [`run_subset()`](https://jllcalorio.github.io/pondeR/reference/run_subset.md)
  : Balanced Subsetting of Rows or Columns

- [`run_vector2df()`](https://jllcalorio.github.io/pondeR/reference/run_vector2df.md)
...
- [`select_catvars()`](https://jllcalorio.github.io/pondeR/reference/select_catvars.md)
  : Select Categorical Variables from a Data Frame

- [`select_numvars()`](https://jllcalorio.github.io/pondeR/reference/select_numvars.md)
